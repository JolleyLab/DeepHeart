...
class SegmentEditorDeepHeart(ScriptedLoadableModule):
  ...
  def __init__(self, parent):
    ...
    self.parent.title = "SegmentEditorDeepHeart"
    self.parent.categories = ["Segmentation"]
    self.parent.dependencies = ["ExportHeartData", "MONAILabel"]
...
class SegmentEditorDeepHeartTest(ScriptedLoadableModuleTest):
  """
  ...
  def runTest(self):
    ...
    """
    self.setUp()
    self.test_DeepValveSegmenter1()

  def test_DeepValveSegmenter1(self):
    """
    ...
    The test can be executed from SelfTests module (test name: SegmentEditorDeepHeart)
    """

    self.delayDisplay("Starting test_DeepValveSegmenter1")
    ...
    segmentEditorWidget.setActiveEffectByName("DeepHeart")
    ...
    self.delayDisplay('test_DeepValveSegmenter1 passed')
